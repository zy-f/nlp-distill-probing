...
from utils import log_metrics, current_pst_time, acc_func, DotDict, mnli_tok_func
...
hparams = DotDict(
    ...
    n_epochs = 10,
    bsz = 64,
    distloss__dist_ce_wt=1,
    distloss__hard_ce_wt=0,
    distloss__temp=2
)

device = 'cuda:0'
# run_name = 'raw_distilbert_distfinetune_onlyDistLoss'
run_name = 'distilbert_distfinetune_onlyDistLoss'
